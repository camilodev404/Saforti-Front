        ...
        <div>
            ...
            <div>
                <div className="col" style={{ textAlign: 'left', marginLeft: '0.5vw', marginTop: '1vw' }}>
                    ...
                    <input onChange={handlerChange} type="radio" id="si" name="haSidoBeneficiario" value={true} style={{ marginRight: '1vw' }}/>
                    <label htmlFor="no" style={{ marginRight: '1vw' }}>No</label>
                    <input onChange={handlerChange} type="radio" id="no" name="haSidoBeneficiario" value={false}  />
                </div>
                <div className="col" style={{ textAlign: 'left', marginLeft: '0.5vw', marginTop: '1vw' }}>
                    <label style={{ marginRight: '3vw' }}>27. ¿Cuenta con algún documento que acredita el beneficio?</label>
                    <label htmlFor="si" style={{ marginRight: '1vw' }}>Si</label>
                    <input onChange={handlerChange} type="radio" id="si" name="acreditaBeneficio" value={true} style={{ marginRight: '1vw' }}/>
                    <label htmlFor="no" style={{ marginRight: '1vw' }}>No</label>
                    <input onChange={handlerChange} type="radio" id="no" name="acreditaBeneficio" value={false}  />
                </div>
                <div className="col" style={{ textAlign: 'left', marginLeft: '0.5vw', marginTop: '1vw' }}>
                    ...
                    <label style={{ marginRight: '2vw', marginTop: '0.5vw' }}>Fecha Acreditación:</label>
                    <input onChange={handlerChange} id="fechaAcreditacion" name="fechaAcreditacion" style={{ borderRadius: '10px', width: '17vw', marginRight: '1.5vw', borderColor: '#037250', borderWidth: '1px', borderStyle: 'solid', height: '1.5vw' }} type="text"/>
                </div>
            </div>
